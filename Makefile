...
test: clean ## run tests in the current virtualenv
	...
	cp .coverage .coverage-rabbit
	python -Wd -m pytest --cov --cov-report term-missing --ds=xqueue.test_settings_no_rabbit queue
	cp .coverage .coverage-no-rabbit
